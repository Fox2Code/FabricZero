...
class FabricZeroRules {
    static void builtIn() {
        ...
        api.addCurseProjectId("compact-storage", 223703);
        ...
        api.addCurseProjectId("dynamicfps", 335493);
        ...
        api.addCurseProjectId("fabric-furnaces", 315534);
        ...
        api.addCurseProjectId("harvest", 240783); // SimpleHarvest
        ...
        api.addCurseProjectId("itemscroller", 242064);
        api.addCurseProjectId("lightoverlay", 325492);
        api.addCurseProjectId("litematica", 308892);
        api.addCurseProjectId("lithium", 360438);
        api.addCurseProjectId("malilib", 303119);
        api.addCurseProjectId("minecraftcapes", 359836);
        ...
        api.addCurseProjectId("repurposed_structures", 391366);
        api.addCurseProjectId("respawnablepets", 319582);
        api.addCurseProjectId("roughlyenoughitems", 310111);
        api.addCurseProjectId("roughlyenoughresources", 325625);
