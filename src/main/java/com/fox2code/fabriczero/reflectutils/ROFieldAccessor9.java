...
/**
 * Exact copy of {@link ROFieldAccessor8} but for java9+
 */
final class ROFieldAccessor9 implements FieldAccessor {
    private final FieldAccessor handle;

    public static Object from(Object fieldAccessor) {
        return new ROFieldAccessor9((FieldAccessor) fieldAccessor);
    }

    private ROFieldAccessor9(FieldAccessor handle) {
        this.handle = handle;
    }
